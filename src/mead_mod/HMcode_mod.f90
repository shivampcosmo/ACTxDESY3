...
MODULE MHM
  ...
  DO j=1,nz
     ...
     CALL halomod_init(z,numin,numax,lut,cosi,umh,bth)
  ...
  SUBROUTINE halomod(k,z,p1h,p2h,pfull,plin,lut,cosm,umh,bth,massh)
  ...
  SUBROUTINE halomod_init(z,nu_min,nu_max,lut,cosm,umh,bth)
  ...
  FUNCTION u_m(k,z,lut,cosm)
    ...
    !Only call eta once
    et=eta(z,cosm) ! This is one of the HALO MODEL PAR
