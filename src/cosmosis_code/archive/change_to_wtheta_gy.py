...
out_dict = np.load(
    '/global/cfs/cdirs/des/shivamp/cosmosis/ACTxDESY3/src/results/results_block_ell_gg_gy_maglim_2mrs_beamed.npz')
theta_min = 1.0
theta_max = 100.
ntheta = 10
...
np.savez('/global/project/projectdirs/des/shivamp/cosmosis/ACTxDESY3/src/results/results_wtheta_gg_maglim_2mrs_beamed.npz', **wtheta_gg_dict)
np.savez('/global/project/projectdirs/des/shivamp/cosmosis/ACTxDESY3/src/results/results_wtheta_gy_maglim_2mrs_beamed.npz', **wtheta_yg_dict)
