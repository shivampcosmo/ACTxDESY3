...
np.savez('/global/project/projectdirs/des/shivamp/cosmosis/ACTxDESY3/src/results/results_wtheta_kk_desy1.npz', **wtheta_kk_dict)
np.savez('/global/project/projectdirs/des/shivamp/cosmosis/ACTxDESY3/src/results/results_wtheta_ky_desy1.npz', **wtheta_ky_dict)
np.savez('/global/project/projectdirs/des/shivamp/cosmosis/ACTxDESY3/src/results/results_xi_gty_desy1.npz', **xi_gty_dict)
