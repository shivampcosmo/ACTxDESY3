...
class makeplot:
    ...
    def collect_Pe_mat(self,chain_file=None, nsamps=100, x_min = 0.1, x_max = 3, numx=30):
        ...
        if chain_file is not None:
            ...
            Pe_mat = np.zeros((nsample,self.nz,self.nm,numx))
            ...
            for pi in range(nsample):
                ...
                other_params['pressure_fid'] = pressure_params
                pressure = Pressure(cosmo_params, pressure_params, other_params)
                Pe_pi = pressure.get_Pe_mat(self.M_mat, x_array, self.other_params_dict['z_array'], self.R_mat)
                Pe_mat[pi,:,:,:] = Pe_pi
            
            return self.z_array,self.M_mat,x_array, Pe_mat, Pe_fid, weights
        else:
            return self.z_array,self.M_mat,x_array, Pe_fid
...
chain_f = '/global/cfs/cdirs/des/shivamp/nl_cosmosis/cosmosis/ACTxDESY3/src/chains/chain_gty_only_fidcuts_HM_delz_m_IA_P0A_P0z_betaA_alphigh_highbpl_al1_PLcosmo_finalrun4.txt'
save_data_fname = 'Pe_plot_data_gty_only_fidcuts_HM_delz_m_IA_P0A_P0z_betaA_alphigh_highbpl_al1_PLcosmo_finalrun4.pk'
save_plot_fname = 'Pe_gty_only_fidcuts_HM_delz_m_IA_P0A_P0z_betaA_alphigh_highbpl_al1_PLcosmo_finalrun4.pdf'

# pf_main = 'final_runs/params_des_ky_planckacty3_beamed_B12.ini'
# chain_f = '/global/cfs/cdirs/des/shivamp/nl_cosmosis/cosmosis/ACTxDESY3/src/chains/chain_gty_only_fidcuts_HM_delz_m_IA_P0A_P0z_al1_PLcosmo_finalrun3.txt'
# save_data_fname = 'Pe_plot_data_gty_only_fidcuts_HM_delz_m_IA_P0A_P0z_al1_PLcosmo_finalrun3.pk'
# save_plot_fname = 'Pe_gty_only_fidcuts_HM_delz_m_IA_P0A_P0z_al1_PLcosmo_finalrun3.pdf'
...
z_array,M_mat,x_array, Pe_mat, Pe_fid,weights = mp.collect_Pe_mat(chain_file=chain_f, nsamps=nsamps)

savedict = {'z':z_array, 'M_mat':M_mat,'x_array':x_array,'Pe_fid':Pe_fid,'Pe_mat':Pe_mat,'weights':weights}
