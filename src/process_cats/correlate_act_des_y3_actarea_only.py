...
def parse_arguments():
    ...
    parser.add_argument('--dogg', type=bool, default=False, help='deproj type')
...
if __name__ == "__main__":
    ...
    if deproj == 'cib_jch':
        true_y_file = ydir + 'tilec_single_tile_deep56_comptony_deprojects_cib_map_test2v1.2.0_joint_JCH_betaCIB' + str(betacib) + '.fits'        
    if deproj == 'cmb':
    ...
    for jz in range(len(zmin_bins)):
        ...
        filename = save_dir + 'dy/dy_' + 'act_deprojects_' + str(deproj) + '_v1.2.0_' + 'wbeam' + '_pixell' + '_' + file_suffix_save + '_hrespixell_ACTareaonly_v26Jan21.pk'
